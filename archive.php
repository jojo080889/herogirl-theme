...
?>
	...
	<?php if (have_posts()) : ?>
		<?php 
			if (is_category() && in_comic_category() && $comicpress_options['archive_display_comic_thumbs_in_order']) {
	...
	<?php if ($comicpress_options['archive_display_comic_thumbs_in_order']) { ?>
