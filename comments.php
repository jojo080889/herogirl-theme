...
<?php if ('open' == $post->comment_status) : ?>
	...
	<div id="respond">
		...
		<?php if ( get_option('comment_registration') && !$user_ID ) : ?>
			<p><?php _e('You must be','comicpress'); ?> <a href="<?php echo get_bloginfo('url'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>"><?php _e('logged in','comicpress'); ?></a> <?php _e('to post a comment.','comicpress'); ?></p>
		<?php else : ?>
			<form action="<?php echo get_option('url'); ?>/wp-comments-post.php" method="post" id="commentform">
				<?php if ( $user_ID ) : ?>
					<p><?php _e('Logged in as','comicpress'); ?> <a href="<?php echo get_option('url'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account','comicpress'); ?>"><?php _e('Log out &raquo;','comicpress'); ?></a></p>
				<?php else : ?>
