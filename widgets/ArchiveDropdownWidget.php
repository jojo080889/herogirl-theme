...
register_widget('ComicPressArchiveDropdownWidget');


function ComicPressArchiveDropdownWidget_init() {    
	new ComicPressArchiveDropdownWidget(); 
} 

add_action('widgets_init', 'ComicPressArchiveDropdownWidget_init');
