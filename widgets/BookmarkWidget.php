...
register_widget('ComicPressBookmarkWidget');


function ComicPressBookmarkWidget_init() { 
	new ComicPressBookmarkWidget(); 
} 

add_action('widgets_init', 'ComicPressBookmarkWidget_init');
