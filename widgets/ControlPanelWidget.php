...
class ComicPressControlPanelWidget extends WP_Widget {
	...
	global $wpmu_version; ?>
		<?php if (!is_user_logged_in()) { ?>
			...
			<br />
			<ul>
			<?php if (!empty($wpmu_version) || defined('VHOST') ) { ?>
...
register_widget('ComicPressControlPanelWidget');


function ComicPressControlPanelWidget_init() {    
	new ComicPressControlPanelWidget(); 
} 

add_action('widgets_init', 'ComicPressControlPanelWidget_init');
?>