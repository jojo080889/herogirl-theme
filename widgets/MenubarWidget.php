...
register_widget('ComicPressMenubarWidget');


function ComicPressMenubarWidget_init() {    
	new ComicPressMenubarWidget(); 
} 

add_action('widgets_init', 'ComicPressMenubarWidget_init');
