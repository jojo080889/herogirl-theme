...
register_widget('ComicPressTranscriptSearchWidget');


function ComicPressTranscriptSearchWidget_init() {    
	new ComicPressTranscriptSearchWidget(); 
} 

add_action('widgets_init', 'ComicPressTranscriptSearchWidget_init');
?>